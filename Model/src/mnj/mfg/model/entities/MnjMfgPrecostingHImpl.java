...
public class MnjMfgPrecostingHImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for CostingStatus, using the alias name CostingStatus.
     * @return the CostingStatus
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for CostingStatus.
     * @param value value to set the CostingStatus
     */
    ...
    protected void create(AttributeList attributeList) {
        ...
        public int getSrNoString() {
          ...
          System.out.println("......header no return is "+srno);
          return srno;
...
//    }
    ...
    protected void doDML(int operation, TransactionEvent e) {
        ...
        System.out.println("user id="+user+"date is="+date);
        
        if(user == null || date == null ){        
                
               
                throw new JboException("user or creation date is blank, please login again. .");

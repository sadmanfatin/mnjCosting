...
public class PopUpBean {
    ...
    Main myBean;
    private RichTable updateTable;
    private RichInputText headerId;
    private RichTable bpOHTable;
    private RichTable bpoLinetable;
    private RichInputText bpoQtyLineBind;
    private RichInputText blncLineBind;
    private ViewObject LineBPOVo;
    private RichOutputText tbAQty_Bind;
    private RichTable sizeTab;
    ...
    public String createOrder() {
        ...
        BindingContainer bindings = bctx.getCurrentBindingsEntry();
        OperationBinding operationBinding =
            bindings.getOperationBinding("createOrder");
...
//            }
    ...
    //                                              break;
                                  ...
                                  case 1: rw.setAttribute("BpoQty", theToken);
                                          break;
                                  case 2: rw.setAttribute("Clasfic", theToken);
                                          break;
                                  case 3: rw.setAttribute("Incoterms", theToken);
                                          break;
                                  case 4: rw.setAttribute("PoType", theToken);
                                          break;
                                 case 5: rw.setAttribute("ReplaceBpo", theToken);
                                          break;
                                  case 6: rw.setAttribute("Country", theToken);
                                          break;
                                  case 7: rw.setAttribute("ShipMode", theToken);
                                          break;
                                  case 8: rw.setAttribute("DeliveryStartDate", theToken);
                                          break;
                                  case 9: rw.setAttribute("DeliveryEndDate", theToken);
                                          break;
